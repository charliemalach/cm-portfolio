...
def buy():
    ...
    if request.method == "GET":
        ...
        if not symbol:
            return apology("Error: Must provide symbol.")

        stock = lookup(symbol.upper())

        if stock == None:
            return apology("Error: Symbol does not exist.")

        if shares < 0:
            return apology("Error: Share is not Valid.")
        ...
        if user_cash < transaction_value:
            return apology("Error: Not enough money.")
...
def add_cash():
    ...
    if request.method == "GET":
        ...
        if not new_cash:
            return apology("Error: You must enter funds")
...
def register():
    ...
    if request.method == "GET":
        ...
        if not username:
            return apology("Please provide the username.")

        if not password:
            return apology("Please provide the password.")

        if not confirmation:
            return apology("Please confirm password.")

        if password != confirmation:
            return apology("Error: Password does not match.")
...
def sell():
    ...
    if request.method == "GET":
        ...
        if shares > user_shares_real:
            return apology("Error: You do not have this number of shares!")
